    ...
    public static function getACCOUNT_TYPE_WAITING()
    {
        return [
            'investor_status_verified' => [
                ...
                'text' => __('Abyste mohli využívat všechny funkce portálu v roli investora, zejména podávat nabídky u projektů, musíme ověřit oprávněnost vašeho zájmu o využití tohoto typu účtu.'),
                'class' => 'bg-app-orange',
            ...
            'advertiser_status_verified' => [
                ...
                'text' => __('Abyste mohli využívat všechny funkce portálu v roli nabízejícího, zejména zveřejňovat projekty k prodeji, musíme ověřit oprávněnost vašeho zájmu o využití tohoto typu účtu.'),
                'class' => 'bg-app-orange',
            ...
            'real_estate_broker_status_verified' => [
                ...
                'text' => __('Abyste mohli využívat všechny funkce portálu v roli realitního makléře, zejména zveřejňovat projekty k prodeji, u kterých zastupujete vlastníka, musíme ověřit oprávněnost vašeho zájmu o využití tohoto typu účtu.'),
                'class' => 'bg-app-orange',
