        ...
        <div class="py-[25px] px-[20px] md:py-[35px] md:px-0">
            <div class="max-w-[1230px] mx-auto px-[15px]">
                <div class="grid gap-[20px] md:gap-[100px] md:grid-cols-[1fr_max-content]">
                    <div class="">
                        <h2 class="mb-[25px] md:mb-[30px]">I my zpracováme cookies</h2>
                     ...
                     desktop:text-[15px] overflow-y-auto max-tablet:max-h-[20vh] mb-0 pb-[5px]">
                            <div>
                                Naše webové stránky používají pro své správné fungování cookies a podobné technologie.
                                Některé jsou nezbytně nutné pro základní fungování. Bez nich se neobejdeme.
                                Jiné nám slouží k vytváření anonymních statistik o chování návštěvníků nebo pro inzerci
                                reklamních obsahů. S jejich používáním však potřebujeme váš souhlas.
                                Souhlasy s používáním jednotlivých typů cookies si můžete nastavit pod odkazem
                                "Upravit".
                            </div>
                    ...
                    <div class="grid gap-[15px] md:gap-[20px] content-start items-start md:min-w-[225px]">
                        <button class="font-Spartan-SemiBold text-white bg-app-green rounded-[3px] shadow-[0_3px_6px_rgba(0,0,0,0.16)]
                            h-[50px] leading-[50px] w-full text-[14px] tablet:text-[16px]"
                                @click="$dispatch('set-cookies-options-all')">Povolit všechny
                        </button>
                        <button class="font-Spartan-Regular text-[#31363A] bg-white rounded-[3px] shadow-[0_3px_6px_rgba(0,0,0,0.16)]
                            h-[50px] leading-[50px] w-full text-[14px] tablet:text-[16px]"
                                @click="$dispatch('modal-cookies-options')">Upravit
                        </button>
                        <button class="font-Spartan-Regular text-[#31363A] bg-white rounded-[3px] shadow-[0_3px_6px_rgba(0,0,0,0.16)]
                            h-[50px] leading-[50px] w-full text-[14px] tablet:text-[16px]"
                                @click="$dispatch('set-cookies-options-none')">Odmítnout všechny
                        </button>
                    </div>
                </div>
            </div>
