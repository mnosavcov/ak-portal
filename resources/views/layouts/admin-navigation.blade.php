        ...
        <div class="p-4">
            ...
            <div class="py-4 text-gray-400 space-y-1">
                ...
                <a href="{{ route('admin.faq') }}"
                   class="py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded">
                    <i class="w-6 h-6 leading-6 fa-regular fa-circle-question text-center"></i>
                ...
                <a href="{{ route('admin.projects') }}"
                   class="py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded">
                    ...
                    <span>{{ __('admin.Projekty') }}</span>
                </a>

                <a href="{{ route('admin.payments.show') }}"
                   class="py-2.5 px-4 flex items-center space-x-2 bg-gray-800 text-white hover:bg-gray-800 hover:text-white rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" stroke="currentColor" viewBox="0 0 320 512"
                         width="24" height="24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
