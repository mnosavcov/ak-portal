                        ...
                        <div>
                            ...
                            <div class="mt-[15px]"
                                ...
                                <button
                                    ...
                                    :disabled="(typeof longTextTranslateData[getSelectedLanguage()] !== 'undefined' && typeof longTextTranslateData[getSelectedLanguage()][getSelectedLanguageCategory()] !== 'undefined') && longTextTranslateData[getSelectedLanguage()][getSelectedLanguageCategory()] === longTextTranslateOriginData[getSelectedLanguage()][getSelectedLanguageCategory()]"
                                >Zrušit změny
                                </button>
                                <button
                                    @click.prevent="
