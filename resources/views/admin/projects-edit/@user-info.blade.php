<div class="relative w-full max-w-[1200px] p-[15px] pl-[50px] bg-[#d8d8d8] mb-[30px] rounded-[7px] file-Spartan-Regular text-[13px] text-[#676464] leading-[24px]
    ...
    <div class="w-full grid grid-cols-5 gap-x-[20px] gap-y-[10px]">
        ...
        <div>
            ...
            <div>{!! $project->user->investor ? '<span class="bg-app-orange p-[5px] rounded-[3px] text-white">Ano</span>' : '<span class="bg-gray-400 p-[5px] rounded-[3px] text-white">Ne</span>' !!}</div>
        </div>
        <div>
            <div class="font-bold">Nazízející:</div>
            <div>{!! $project->user->advertiser ? '<span class="bg-app-orange p-[5px] rounded-[3px] text-white">Ano</span>' : '<span class="bg-gray-400 p-[5px] rounded-[3px] text-white">Ne</span>' !!}</div>
        </div>
        <div>
            <div class="font-bold">Real. makléř:</div>
            <div>{!! $project->user->real_estate_broker ? '<span class="bg-app-orange p-[5px] rounded-[3px] text-white">Ano</span>' : '<span class="bg-gray-400 p-[5px] rounded-[3px] text-white">Ne</span>' !!}</div>
        </div>
        ...
        <div>
            ...
            <div>{!! $project->user->check_status === 'verified' ? '<span class="bg-app-orange p-[5px] rounded-[3px] text-white">Ano</span>' : '<span class="bg-gray-400 p-[5px] rounded-[3px] text-white">Ne</span>' !!}</div>
        </div>
    </div>
</div>
