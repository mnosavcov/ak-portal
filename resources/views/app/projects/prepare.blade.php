        ...
        <div class="w-full max-w-[1230px] mx-auto">
            <div class="mx-[15px]">
                ...
                after:absolute after:bg-[url('/resources/images/ico-info-orange.svg')] after:w-[20px] after:h-[20px] after:left-[15px] after:top-[15px]">
                    ...
                    <div
                        ...
                        <h2 class="mb-[25px]">
                            @if($project->status === 'send')
                                {{ __('Projekt jste zadali a čeká na zpracování') }}
                            @elseif($project->status === 'prepared')
                                {{ __('Projekt je připravený k vypublikování') }}
                            @elseif($project->status === 'confirm')
                                {{ __('Projekt jste potvrdili, brzy bude vypublikován') }}
                            @elseif($project->status === 'reminder')
                                {{ __('Podali jste připomínku k projektu a čeká na zpracování') }}
                            @else
                                {{ $project->status }}
                            @endif
                        </h2>
                            ...
                            <div class="mt-[25px]" x-data="{ reminder: false, reminder_text: '', minLength: 2 }">
                                <form method="post" action="{{route('projects.confirm', ['project' => $project])}}">
                                    ...
                                    <button type="submit" name="type" value="confirm"
                                        ...
                                        {{ __('Portvdit projekt a poslat souhlas s publikováním') }}
                                    </button>
                    ...
                    <div
                        class="bg-white px-[15px] pt-[30px] tablet:px-[30px] tablet:pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                        <h2 class="mb-[25px]">{{ __('Stav projektu') }}</h2>
                        <div class="bg-[#F8F8F8] rounded-[3px] p-[20px_15px] tablet:p-[20px_25px]">
                    ...
                    <div
                        class="bg-white px-[15px] pt-[30px] tablet:px-[30px] tablet:pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                        <h2 class="mb-[25px]">{{ __('Detaily projektu') }}</h2>
                        <div class="bg-[#F8F8F8] rounded-[3px] p-[20px_15px] tablet:p-[20px_25px]">
                    ...
                    <div
                        class="bg-white px-[15px] pt-[30px] tablet:px-[30px] tablet:pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                        <h2 class="mb-[25px]">{{ __('Dokumenty') }}</h2>
                        <div class="bg-[#F8F8F8] rounded-[3px] p-[20px_15px] tablet:p-[20px_25px]">
                    ...
                    <div
                        class="bg-white px-[15px] pt-[30px] tablet:px-[30px] tablet:pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                        <h2 class="mb-[25px]">{{ __('Fotografie') }}</h2>
                        <div class="bg-[#F8F8F8] rounded-[3px] p-[20px_15px] tablet:p-[20px_25px]">
                    ...
                    <div
                        ...
                        <h2 class="mb-[25px]">{{ __('Nastavení projektu') }}</h2>
                        <div class="bg-[#F8F8F8] rounded-[3px] p-[20px_15px] tablet:p-[20px_25px]">
                ...
                <div x-show="!selectedProject" x-collapse>
                    <div
                        class="bg-white px-[15px] pt-[30px] tablet:px-[30px] tablet:pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                        <h2 class="mb-[25px]">{{ __('Upřesnění projektu') }}</h2>
                        <div
                            ...
                            <div class="font-Spartan-SemiBold text-[13px] leading-[24px] text-[#414141]">
                                {!! __('Stupeň&nbsp;rozpracovanosti&nbsp;projektu') !!}
                            </div>
                            <div
                                class="font-Spartan-Regular text-[13px] leading-[24px] text-[#414141] max-tablet:mb-[15px]">{!! \App\Services\ProjectService::getSUBJECT_OFFERS_ALL_VERSIONS()[$project->subject_offer] ?? $project->subject_offer !!}</div>

                            <div class="font-Spartan-SemiBold text-[13px] leading-[24px] text-[#414141]">
                                {{ __('Předmět nabídky') }}
                            </div>
                            <div
                                class="font-Spartan-Regular text-[13px] leading-[24px] text-[#414141] max-tablet:mb-[15px]">{!! \App\Services\ProjectService::getLOCATION_OFFERS_ALL_VERSIONS()[$project->location_offer] ?? $project->location_offer !!}</div>
                        ...
                        <div class="font-Spartan-Regular text-[20px] leading-[30px] text-[#414141] mb-[25px]">
                            {{ __('Podrobné informace o projektu') }}
                        </div>
                    ...
                    <div
                        class="bg-white px-[15px] pt-[30px] tablet:px-[30px] tablet:pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                        <h2 class="mb-[25px]">{{ __('Preferovaný způsob prodeje projektu') }}</h2>
                        ...
                        <div class="bg-[#F8F8F8] rounded-[3px] p-[25px] max-w-[900px] text-[13px]">
                            <div class="font-Spartan-SemiBold text-[13px] leading-[24px] text-[#414141] mb-[15px]">
                                {{ \App\Models\Project::getPAID_TYPES()[$project->type]['text'] ?? 'Chybně definováno "' . $project->type . '"' }}
                            </div>
                            <div class="font-Spartan-Regular text-[13px] leading-[22px] text-[#414141]">
                                {{ \App\Models\Project::getPAID_TYPES()[$project->type]['description'] ?? '' }}
                            </div>
                        </div>
                    </div>
                    ...
                    @if($project->user_account_type === 'real-estate-broker')
                        <div
                            class="bg-white px-[15px] pt-[30px] tablet:px-[30px] tablet:pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                            <h2 class="mb-[25px]">{{ __('Forma zastoupení klienta') }}</h2>

                            <div class="bg-[#F8F8F8] rounded-[3px] p-[25px] max-w-[900px] text-[13px]">
                                <div class="font-Spartan-SemiBold text-[13px] leading-[24px] text-[#414141] mb-[15px]">
                                    {{ \App\Models\Project::getREPRESENTATION_OPTIONS()[$project->representation_type]['text'] ?? '-' }}
                                </div>
                                <div class="font-Spartan-Regular text-[13px] leading-[22px] text-[#414141]">
                                    {{ \App\Models\Project::getREPRESENTATION_OPTIONS()[$project->representation_type]['description'] ?? '-' }}
                                </div>
                            </div>
