<x-app-layout>
    <div x-data="{ selectedProject: true }">
        ...
        <div x-show="selectedProject" x-collapse class="app-project">
            ...
            <div
                class="bg-white px-[30px] pt-[50px] pb-[25px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[50px] max-w-[1200px] mx-auto">
                <h2 class="mb-[25px]">
            ...
            <div
                class="bg-white px-[30px] py-[50px] shadow-[0_3px_35px_rgba(0,0,0,0.10)] rounded-[3px] mb-[100px] max-w-[1200px] mx-auto">
        ...
        <div x-show="!selectedProject" x-collapse>
            <div
                ...
                <div
                    ...
                    <div class="font-Spartan-SemiBold text-[13px] leading-[24px] text-[#414141]">Umístění projektu</div>
                    <div
                    ...
                    <div class="font-Spartan-SemiBold text-[13px] leading-[24px] text-[#414141]">Název projektu</div>
                    <div
                        class="font-Spartan-Regular text-[13px] leading-[24px] text-[#414141]">{{ $project->title }}</div>

                    <div class="font-Spartan-SemiBold text-[13px] leading-[24px] text-[#414141]">Země umístění projektu
                    </div>
                    <div
