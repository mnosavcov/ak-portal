                ...
                <div
                    ...
                    <div>
                        <div class="font-Spartan-Bold text-[13px] leading-[22px] text-[#414141]">
                            Pro zobrazení všech aktualit se musíte přihlásit jako investor a
                            mít ověřený účet.
                        </div>
                    ...
                    ">
                        <div>
                            <div class="font-Spartan-Bold text-[13px] leading-[22px] text-[#414141]">
                                ...
                                detailů o projektu, mezi které patří i aktuality, musíte nabízejícího požádat.
                            </div>
                        </div>
...
<x-modal name="actuality-info">
    <div class="p-[40px_10px] tablet:p-[50px_40px] text-center">
        ...
        <h2 class="mb-[25px]">Aktuality</h2>


        <div class="text-left font-Spartan-Regular text-[16px]">
            Aktuality podléhají schvalování administrátorem. Jelikož provozovatel připravoval podstatnou část popisu
            projektu a zároveň je na úspěšném zobchodování závislé vyplacení jeho provize, má oprávněný zájem na
            kontrolu, zda je obsah a forma aktuality relevantní. Jakékoliv zavádějící či nevhodné informace by mohly
            negativně ovlivnit průběh projektu. Provozovatel si vyhrazuje právo provést úpravu aktualit, nebo je i v
            důvodných případech nezveřejnit.
        </div>
    </div>
</x-modal>
