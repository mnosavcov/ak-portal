<x-email-layout>
    ...
    jednotlivých projektů zveřejněna. V případě, že bude vaše nabídka vítězná, budete vyzváni k podpisu rezervační
    smlouvy a následné úhradě rezervačního poplatku do advokátní či notářské úschovy. K převodu projektu dojde až po
    podpisu kupní smlouvy. Celý proces zobchodování je detailně popsán ve <a href="{{ route('vseobecne-obchodni-podminky') }}">Všeobecných obchodních podmínkách</a>.
    <br>
    <br>
