...
<div x-data="{
    ...
    <div
        class="relative rounded-[3px] font-Spartan-Regular text-[13px] text-[#414141] border border-[#e2e2e2] h-[45px] leading-[45px] px-[12px] cursor-pointer
         after:absolute after:bg-[url('/resources/images/dropdown-mark.svg')] after:w-[10px] after:h-[6px] after:right-[12px] after:top-[19px] after:transform after:transition"
    ...
    <div class="relative"
        ...
        <div
            class="w-full h-[269px] absolute z-10 top-[0px] overflow-y-auto border-b border-b-[#e2e2e2] rounded-[0_0_3px_3px]">
